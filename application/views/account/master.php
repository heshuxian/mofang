...
<!--                                    <img src="img/avatar3.png" class="img-circle" alt="User Image" />-->
     ...
     <!--               		<?php if($userObj->user_role == 'admin'){?> -->
       ...
       <!--                 <?php }?>-->
                        <li <?php if($actLi == 'cooperation'){?> class="active" <?php }?>>
                            <a href="/account/cooperationmanage">
                                <i class="fa fa-th"></i>
                                <span>合作机构管理</span>
                            </a>
                        </li>
                        <li <?php if($actLi == 'friendship'){?> class="active" <?php }?>>
                            <a href="/account/friendshipmanage">
                                <i class="fa fa-th"></i>
                                <span>友情链接管理</span>
                            </a>
                        </li>
